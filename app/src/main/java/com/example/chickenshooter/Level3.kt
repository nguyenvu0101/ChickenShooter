...
// Với đàn gà (swarms)
    ...
    override fun cleanup() {
        try {
            super.cleanup()
            android.util.Log.d("Level3", "Cleaning up Level3 specific resources...")
            ...
            android.util.Log.d("Level3", "Level3 cleanup completed")
        } catch (e: Exception) {
            android.util.Log.e("Level3", "Error during Level3 cleanup: ${e.message}")
            e.printStackTrace()
        }
    }
}
